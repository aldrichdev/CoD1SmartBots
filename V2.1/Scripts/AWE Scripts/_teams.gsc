...
precache()
{
	...
	case "american":
		...
		precacheItem("noobtube_mp");
		precacheItem("remi_shotgun_mp"); // Shotgun
		break;
...
///////////////////////
	...
	level.allow_minigun = getCvar("scr_allow_minigun");
	if(level.allow_minigun == "")
		level.allow_minigun = "0";
	setCvar("scr_allow_minigun", level.allow_minigun);
	setCvar("ui_allow_minigun", level.allow_minigun);
	makeCvarServerInfo("ui_allow_minigun", "0");

	level.allow_noobtube = getCvar("scr_allow_noobtube");
	if(level.allow_noobtube == "")
		level.allow_noobtube = "0";
	setCvar("scr_allow_noobtube", level.allow_noobtube);
	setCvar("ui_allow_noobtube", level.allow_noobtube);
	makeCvarServerInfo("ui_allow_noobtube", "0");


	level.allow_shotgun = getCvar("scr_allow_shotgun");
	if(level.allow_shotgun == "")
		level.allow_shotgun = "0";
	setCvar("scr_allow_shotgun", level.allow_shotgun);
	setCvar("ui_allow_shotgun", level.allow_shotgun);
	makeCvarServerInfo("ui_allow_shotgun", "0");
...
///////////////////////
		...
		scr_allow_minigun = getCvar("scr_allow_minigun");
		if(level.allow_minigun != scr_allow_minigun)
		{
			level.allow_minigun = scr_allow_minigun;
			setCvar("ui_allow_minigun", level.allow_minigun);
		}

		scr_allow_noobtube = getCvar("scr_allow_noobtube");
		if(level.allow_noobtube != scr_allow_noobtube)
		{
			level.allow_noobtube = scr_allow_noobtube;
			setCvar("ui_allow_noobtube", level.allow_noobtube);
		}

		scr_allow_shotgun = getCvar("scr_allow_shotgun");
		if(level.allow_shotgun != scr_allow_shotgun)
		{
			level.allow_shotgun = scr_allow_shotgun;
			setCvar("ui_allow_shotgun", level.allow_shotgun);
		}
...
restrictPlacedWeapons()
{
	...
	if(level.allow_minigun != "1")
		deletePlacedEntity("mpweapon_minigun");
	if(level.allow_noobtube != "1")
		deletePlacedEntity("mpweapon_noobtube");
...
/////////////////////////////////////////
			case "minigun_mp":
				if(!getcvar("scr_allow_minigun"))
				{
					self iprintln(&"Minigun is restricted...");
					response = "restricted";
				}
				break;

			case "noobtube_mp":
				if(!getcvar("scr_allow_noobtube"))
				{
					self iprintln(&"NoobTube is restricted...");
					response = "restricted";
				}
				break;

			case "remi_shotgun_mp":
				if(!getcvar("scr_allow_shotgun"))
				{
					self iprintln(&"Shotgun is restricted...");
					response = "restricted";
				}
				break;
